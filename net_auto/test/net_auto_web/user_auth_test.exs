defmodule NetAutoWeb.UserAuthTest do
  use NetAutoWeb.ConnCase, async: true

  alias NetAuto.Accounts
  alias NetAuto.Accounts.Scope
  alias NetAutoWeb.UserAuth

  import NetAuto.AccountsFixtures

  @remember_me_cookie "_net_auto_web_user_remember_me"
  @remember_me_cookie_max_age 60 * 60 * 24 * 14

  setup %{conn: conn} do
    conn =
      conn
      |> Map.replace!(:secret_key_base, NetAutoWeb.Endpoint.config(:secret_key_base))
      |> init_test_session(%{})
